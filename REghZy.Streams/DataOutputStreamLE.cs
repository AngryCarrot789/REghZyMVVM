...
namespace REghZy.Streams {
    ...
    public class DataOutputStreamLE : IDataOutput {
        ...
        public DataOutputStreamLE(Stream stream, SeekOrigin origin, long positon = 0) {
        ...
        public void WriteUShort(ushort value) {
            byte[] b = this.buffer8;
            b[0] = (byte) ((uint) value >> 0);
            b[1] = (byte) ((uint) value >> 8);
            this.stream.Write(b, 0, 2);
        }
            ...
            if (length > 4) {
                ...
                switch (length) {
                    case 4: {
                        ...
                        char c3 = value[2];
                        char c4 = value[3];
                        b[0] = (byte) (c1 >> 0); b[1] = (byte) (c1 >> 8);
                        b[2] = (byte) (c2 >> 0); b[3] = (byte) (c2 >> 8);
                        b[4] = (byte) (c3 >> 0); b[5] = (byte) (c3 >> 8);
                        b[6] = (byte) (c4 >> 0); b[7] = (byte) (c4 >> 8);
                        break;
                    }
                    case 3: {
                        char c1 = value[0];
        ...
        public void WriteString(string value, Encoding encoding) {
            unsafe {
                fixed (char* cptr = value) {
                    WriteCharPtr(cptr, value.Length, encoding);
                }
            }
        }
        ...
        public void WriteChars(char[] chars, Encoding encoding) {
            unsafe {
                fixed (char* cptr = chars) {
                    WriteCharPtr(cptr, chars.Length, encoding);
                }
            }
        }
