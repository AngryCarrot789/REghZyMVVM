...
namespace REghZy.Streams {
    ...
    /// </para>
    /// </summary>
    public class DataInputStreamLE : IDataInput {
        ...
        /// </summary>
        public DataInputStreamLE(Stream stream) {
            this.stream = stream;
        }
        ...
        /// </summary>
        public DataInputStreamLE(Stream stream, SeekOrigin origin, long offset = 0) {
            this.stream = stream;
        ...
        public char[] ReadCharsUTF16(int length) {
            ...
            unsafe {
                ...
                fixed (char* cptr = chars) {
                    while (length > 3) {
                        ReadExact(s, b, 8);
                        cptr[i + 0] = (char) (ushort) ((b[0] << 0) + (b[1] << 8));
                        cptr[i + 1] = (char) (ushort) ((b[2] << 0) + (b[3] << 8));
                        cptr[i + 2] = (char) (ushort) ((b[4] << 0) + (b[5] << 8));
                        cptr[i + 3] = (char) (ushort) ((b[6] << 0) + (b[7] << 8));
                        length -= 4;
                        i += 4;
                    }
                    ...
                    switch (length) {
                        ...
                        case 1:
                            ReadExact(s, b, 2);
                            cptr[i] = (char) (ushort) ((b[0] << 0) + (b[1] << 8));
                            break;
                    }
        ...
        public char[] ReadCharsUTF8(int length) {
            ...
            unsafe {
                ...
                fixed (char* cptr = chars) {
                    while (length > 7) {
                        ReadExact(s, b, 8);
                        cptr[i + 0] = (char) b[0]; cptr[i + 1] = (char) b[1];
                        cptr[i + 2] = (char) b[2]; cptr[i + 3] = (char) b[3];
                        cptr[i + 4] = (char) b[4]; cptr[i + 5] = (char) b[5];
                        cptr[i + 6] = (char) b[6]; cptr[i + 7] = (char) b[7];
                        length -= 8;
                        i += 8;
                    }
        ...
        public void ReadPtr(IntPtr dest, int offset, int length) {
            ...
            while (length > 7) {
                ReadExact(s, b, 8);
                Marshal.WriteInt64(dest, offset, (long) (((ulong) b[0] << 0) +
                                                         ((ulong) b[1] << 8) +
                                                         ((ulong) b[2] << 16) +
                                                         ((ulong) b[3] << 24) +
                                                         ((ulong) b[4] << 32) +
            ...
            if (length > 3) {
                ReadExact(s, b, 4);
                Marshal.WriteInt32(dest, offset, (int) (((uint) b[0] << 0) +
                                                        ((uint) b[1] << 8) +
                                                        ((uint) b[2] << 16) +
                                                        ((uint) b[3] << 24)));
                length -= 4;
