        ...
        public char[] ReadCharsUTF16(int length) {
            ...
            unsafe {
                ...
                if (length > 3) {
                    ...
                    chars[0] = (char) (ushort) ((b[0] << 0) + (b[1] << 8));
                    chars[1] = (char) (ushort) ((b[2] << 0) + (b[3] << 8));
                    chars[2] = (char) (ushort) ((b[4] << 0) + (b[5] << 8));
                    return chars;
                }
                else if (length == 2) {
                    if (s.Read(b, 0, 4) != 4) {
                ...
                unsafe {
                    fixed (byte* ptr = b) {
                        while (length > 7) {
                            ...
                            Marshal.WriteInt64(dest, offset, *(long*) ptr);
                            length -= 8;
                            offset += 8;
                        }
                        ...
                        if (length > 3) {
                            ...
                            Marshal.WriteInt32(dest, offset, *(int*) ptr);
                            length -= 4;
                            offset += 4;
                        }
                    }
